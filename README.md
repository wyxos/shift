...
The screenshots are generated from local-only dummy fixture screens. They do not use production data, hosted SHIFT screenshots, Example data, real clients, real users, or production tokens.
